...
assert.match(platformGuard, /PLATFORM ISOLATION GUARD v4\.11q/);
assert.match(desktopPolish, /DESKTOP POLISH GUARD v4\.11q/);
...
assert.match(desktopCss, /v4\.11q Desktop Card Hierarchy \+ Art Consistency Polish/);

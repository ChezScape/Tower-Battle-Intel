...
const css = fs.readFileSync("./patch/active-control-hotfix.css", "utf8");

assert.match(bridge, /const VERSION = "v4\.10s";/);
...
assert.match(css, /v4\.10s Dropdown \+ Collapsible Fix/);
